...
REM ******************************************************
REM **  Test batch file for TurbSim v1.06.00            **
REM ******************************************************
...
rem SET PROGRAM=CALL ..\bin\TurbSim_Debug_Win32.exe
rem SET PROGRAM=CALL ..\bin\TurbSim_x64.exe
SET PROGRAM=CALL ..\bin\TurbSim_Win32.exe
...
REM ================================================================================================================================
SET TEST=11
SET ROOTNAME=TurbSim_UsrSpec

@SET FN1=%ROOTNAME%.sum
@SET FN2=%ROOTNAME%.wnd

ECHO -------------------------------------------------------------------------
ECHO TurbSim Test #%TEST%:  Validation test for user-defined spectrum.
ECHO -------------------------------------------------------------------------
%PROGRAM% %ROOTNAME%.inp
...
ECHO ########################################################################################### >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO Test #%TEST%:  Validation test for user-defined spectrum                                    >> CertTest.out
ECHO -------------------------------------------------------------------                         >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO ------------------------------------------------------------------------------------------- >> CertTest.out
%Compare% %FN1% TstFiles\%FN1%                                                                   >> CertTest.out

ECHO CompareWNDfiles(   '%FN2%', 'TstFiles\%FN2%' )                                              >> CertTest.m


REM ================================================================================================================================
REM ================================================================================================================================
SET TEST=12
SET ROOTNAME=UsrShear

@SET FN1=%ROOTNAME%.sum
@SET FN2=%ROOTNAME%.bts

ECHO -------------------------------------------------------------------------
ECHO TurbSim Test #%TEST%:  Validation test for user-defined shear.
ECHO -------------------------------------------------------------------------
%PROGRAM% %ROOTNAME%.inp
...
ECHO ########################################################################################### >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO Test #%TEST%:  Validation test for user-defined shear                                       >> CertTest.out
ECHO -------------------------------------------------------------------                         >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO ------------------------------------------------------------------------------------------- >> CertTest.out
%Compare% %FN1% TstFiles\%FN1%                                                                   >> CertTest.out
...
ECHO -------------------------------------------------------------------------
ECHO TurbSim Test #%TEST%:  Validation test for von Karman model with user-defined scaling.
ECHO -------------------------------------------------------------------------
%PROGRAM% %ROOTNAME%.inp
...
ECHO ########################################################################################### >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO Test #%TEST%:  Validation test for von Karman model with user-defined scaling               >> CertTest.out
ECHO -------------------------------------------------------------------                         >> CertTest.out
ECHO.                                                                                            >> CertTest.out
ECHO ------------------------------------------------------------------------------------------- >> CertTest.out
%Compare% %FN1% TstFiles\%FN1%                                                                   >> CertTest.out
